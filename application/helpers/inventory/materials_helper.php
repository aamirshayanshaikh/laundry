		...
		$CI->html->sDivCol(10,'left',1);
			$CI->html->sBox('solid');
				$CI->html->sBoxBody(array('class'=>'paper'));
					$CI->html->sForm("materials/db","general-form");
						...
						$CI->html->sDivRow();
							...
							$CI->html->sDivCol(6);
								$pop = array(
									"href"  => "materials/categories_form?viewpop=1",
									"params"=> array(
										"title" => "Create new material categories",
										"id"    => "create-mat-cat-pop"
									),
								);
								$CI->html->materialCategoryDropPaper('Category:','cat_id',iSetObj($det,'cat_id'),null,array('class'=>'rOkay','pop-form'=>$pop));
							$CI->html->eDivCol();
						$CI->html->eDivRow();
						$CI->html->sDivRow();
							$CI->html->sDivCol(6);
								$CI->html->materialTypeDropPaper('Type:','type',iSetObj($det,'type'),null,array('class'=>'rOkay'));
							$CI->html->eDivCol();
							$CI->html->sDivCol(6);
								$pop = array(
						...
						$CI->html->sDivRow();
							$CI->html->sDivCol(6);
								$CI->html->inputPaper('Cost:','cost',iSetObj($det,'cost'),null,array('class'=>'rOkay'));
							$CI->html->eDivCol();
							$CI->html->sDivCol(6);
								$CI->html->taxTypeDropPaper('Tax Type:','tax_type_id',iSetObj($det,'tax_type_id'),null,array('class'=>'rOkay'));
							$CI->html->eDivCol();
						$CI->html->eDivRow();
					$CI->html->eForm();
				$CI->html->eBoxBody();
...
function categories_form($det=array()){
	...
	$CI->html->sDivRow();
		$CI->html->sDivCol(6,'left',3);
			$CI->html->sBox('solid');
				$CI->html->sBoxBody(array('class'=>'paper'));
					$CI->html->sForm("materials/categories_db","general-form");
						$CI->html->hidden('id',iSetObj($det,'id'));
						$CI->html->sDivRow();
							$CI->html->sDivCol(12);
								$CI->html->inputPaper('Name:','name',iSetObj($det,'name'),null,array('class'=>'rOkay'));
